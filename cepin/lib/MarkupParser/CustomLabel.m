...
-(void)setAttString:(NSAttributedString *)string images:(NSArray *)images
{
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.images) {
        ...
        for (NSDictionary *dic in self.images) {
            UIImage *image = [UIImage imageNamed:[dic objectForKey:@"fileName"]];
            UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
            imageView.frame = CGRectMake(lastX, [[dic objectForKey:@"offsetY"] floatValue], [[dic objectForKey:@"width"] floatValue], [[dic objectForKey:@"height"] floatValue]);
            [self addSubview:imageView];
            
            lastX += ([[dic objectForKey:@"offsetX"] floatValue]+[[dic objectForKey:@"width"] floatValue]);
        }
