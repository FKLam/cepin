...
@end
@implementation AddStudentListVM
...
- (void)addStudent
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance] addThridStudentStartDate:self.studData.StartDate EndDate:self.studData.EndDate userId:userId tokenId:TokenId Level:self.studData.Level Name:self.studData.Name ResumeId:self.resumeId type:@"1"];
    @weakify(self);
