...
- (void)savePractice
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance]saveThridPracticeStartDate:self.pracData.StartDate userId:userId tokenId:TokenId EndDate:self.pracData.EndDate Title:self.pracData.Title Name:self.pracData.Name Content:self.pracData.Content ResumeId:self.resumeId Id:self.pracId];
    @weakify(self);
