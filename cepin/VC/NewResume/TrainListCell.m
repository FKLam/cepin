...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.titlelabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, self.viewWidth - 40, 16.0)];
        ...
        self.timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.titlelabel.viewHeight +self.titlelabel.viewY + 8, self.viewWidth - 40, 14.0)];
        ...
        self.desLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.timeLabel.viewHeight + self.timeLabel.viewY  + 15, self.viewWidth - 40, 12.0)];
        self.desLabel.textColor = [[RTAPPUIHelper shareInstance]subTitleColor];
        self.desLabel.font = [[RTAPPUIHelper shareInstance] searchResultTipsHeadFont];
        ...
        self.btnImage = [[UIImageView alloc]initWithFrame:CGRectMake((70-30)/2, 100*0.25, 36, 36)];
...
- (void)configureWithModel:(TrainingDataModel *)model
{
    ...
    self.titlelabel.text = [TBTextUnit configWithTime:model.Name job:model.Organization];
