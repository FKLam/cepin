...
@implementation AbilltyListCell
...
//    NSString *startime =  [NSDate cepinYMDFromString:model.Date];
    
    self.titleLabel.text = [TBTextUnit configWithTime:model.Name job:model.MasteryLevel];
