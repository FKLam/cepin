...
@interface AddressChooseHuKouVM ()<CLLocationManagerDelegate>
@property (nonatomic, strong) CLLocationManager *locationManager;
@end
@implementation AddressChooseHuKouVM
-(instancetype)initWithSendModel:(ResumeNameModel*)model
{
    if (self = [super init])
    {
        ...
        self.selectedCity = [Region searchRegionWithAddressString:self.sendmodel.Hukou];
...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray<CLLocation *> *)locations
{
    ...
    [geocoder reverseGeocodeLocation:location completionHandler:^(NSArray<CLPlacemark *> * _Nullable placemarks, NSError * _Nullable error) {
        ...
        if ( [weakSelf.addressChooseHuKouDelegate respondsToSelector:@selector(addressChooseHuKouVM:locationCity:)] )
        {
            [weakSelf.addressChooseHuKouDelegate addressChooseHuKouVM:weakSelf locationCity:weakSelf.GPSCity];
        }
    }];
}
