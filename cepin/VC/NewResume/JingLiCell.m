...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.titlelabel = [[UILabel alloc]initWithFrame:CGRectMake(20, 10, self.viewWidth - 40, 15)];
        ...
        self.timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.titlelabel.viewHeight + self.titlelabel.viewY + 8, self.viewWidth - 40, 15)];
        ...
        self.desLabel = [[UILabel alloc]initWithFrame:CGRectMake(20, self.timeLabel.viewHeight + self.timeLabel.viewY + 10, self.viewWidth - 40, 15)];
        self.desLabel.textColor = [[RTAPPUIHelper shareInstance]subTitleColor];
        self.desLabel.font = [[RTAPPUIHelper shareInstance]titleFont];
...
- (void)configureWithModel:(PracticeListDataModel *)model
{
    ...
    self.titlelabel.text = [TBTextUnit configWithTime:model.Name job:model.Title];
