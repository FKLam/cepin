...
- (void)addProject
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance] addThridProjectStartDate:self.projectData.StartDate userId:userId tokenId:TokenId EndDate:self.projectData.EndDate Duty:self.projectData.Duty Name:self.projectData.Name KeyanLevel:self.projectData.KeyanLevel Description:self.projectData.Description Content:self.projectData.Content ResumeId:self.resumeId ProjectLink:self.projectData.ProjectLink IsKeyuan:self.projectData.IsKeyuan];
    @weakify(self);
