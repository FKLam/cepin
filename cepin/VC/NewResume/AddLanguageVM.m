...
- (void)addLanguage
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance] addThridLanguageUserId:userId tokenId:TokenId Name:self.langData.Name BaseCodeKey:self.langData.BaseCodeKey ResumeId:self.resumeId Writing:self.langData.Writing Speaking:self.langData.Speaking];
    @weakify(self);
