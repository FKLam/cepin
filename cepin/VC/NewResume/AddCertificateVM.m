...
@end
@implementation AddCertificateVM
...
- (void)addCredential
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance]addThridCredentialDate:self.credData.Date userId:userId tokenId:TokenId Name:self.credData.Name BaseCodeKey:self.credData.BaseCodeKey ResumeId:self.resumeId Type:@"2"];
    @weakify(self);
