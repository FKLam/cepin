...
//        NSArray *endArray = [self.trainData.EndDate componentsSeparatedByString:@"-"];
        ...
        self.strEndYear = strYear;
        self.strBeginMonth = [beginArray objectAtIndex:1];
        self.strEndMonth = strMonth;
...
- (void)addTrain
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance]addThridTrainStartDate:self.trainData.StartDate userId:userId tokenId:TokenId EndDate:self.trainData.EndDate Organization:self.trainData.Organization Name:self.trainData.Name Content:self.trainData.Content ResumeId:self.resumeId];
    @weakify(self);
