...
{
    NSString *ishasCet4 = @"false";
    NSString *ishasCet6 = @"false";
    NSString *IsHasTEM4 = @"false";
    NSString *IsHasTEM6 = @"false";
    NSString *IsHasTOEFL = @"false";
    NSString *IsHasIELTS= @"false";
    
    if (model.IsHasCET4Score.intValue==1) {
        ishasCet4 = @"true";
        
    }
    if (model.IsHasCET6Score.intValue==1) {
        ishasCet6 = @"true";
        
    }
    if (model.IsHasTEM4Score.intValue==1) {
        IsHasTEM4 = @"true";
        
    }
    if (model.IsHasTEM8Score.intValue==1) {
        IsHasTEM6 = @"true";
        
    }
    if (model.IsHasIELTSScore.intValue==1) {
        IsHasIELTS = @"true";
       
    }
    if (model.IsHasTOEFLScore.intValue==1) {
        IsHasTOEFL = @"true";
...
//    
    RACSignal *signal =  [[RTNetworking shareInstance]saveThridEnglishUserId:userId tokenId:TokenId ResumeId:model.ResumeId IsHasCET4Score:ishasCet4 IsHasCET6Score:ishasCet6 IsHasTEM4Score:IsHasTEM4 IsHasTEM8Score:IsHasTEM6 IsHasIELTSScore:IsHasIELTS IsHasTOEFLScore:IsHasTOEFL CET4Score:[NSString stringWithFormat:@"%@",model.CET4Score] CET6Score:[NSString stringWithFormat:@"%@",model.CET6Score] TEM4Score:[NSString stringWithFormat:@"%@",model.TEM4Score] TEM8Score:[NSString stringWithFormat:@"%@",model.TEM8Score] TOEFLScore:[NSString stringWithFormat:@"%@",model.TOEFLScore] IELTSScore:[NSString stringWithFormat:@"%@",model.IELTSScore]];
