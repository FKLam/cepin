...
-(id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(10, self.viewHeight, 300, 44*3) style:UITableViewStylePlain];
...
-(void)startApper
{
    ...
    rect.origin.y = self.viewHeight-44*3-5;
    self.hidden = NO;
