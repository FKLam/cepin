...
-(void)loadDataWithPage:(NSInteger)page
{
    ...
    RACSignal *signal = [[RTNetworking shareInstance]getDynamicStateCampusFairListWithUUID:UUID_KEY tokenId:strTocken userId:strUser PageIndex:self.page PageSize:self.size];
