...
- (void) drawRect:(CGRect)rect {
    ...
    if (isHighlight) {
        CGContextSetRGBFillColor(contextRef, 0.1, 0.1, 0.3, 0.5);
    ...
    CGContextAddLineToPoint(contextRef, textRect.origin.x + textRect.size.width-5, textRect.origin.y + textRect.size.height + descender+1);
