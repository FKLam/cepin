...
#import "CPCommon.h"
@interface CPSkillCertificateCell ()
@property (nonatomic, strong) UIView *blackBackgroundView;
@property (nonatomic, strong) UIView *whiteBackgroundView;
@property (nonatomic, strong) UILabel *positionLabel;
@property (nonatomic, strong) UILabel *companyLabel;
@property (nonatomic, strong) UILabel *timeLabel;
@property (nonatomic, strong) CredentialListDataModel *certificate;
@end
@implementation CPSkillCertificateCell
...
+ (instancetype)certificateCellWithTableView:(UITableView *)tableView
{
    ...
    CPSkillCertificateCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if ( !cell )
    {
        cell = [[CPSkillCertificateCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
...
- (void)configCellWithCertificate:(CredentialListDataModel *)certificate
{
    ...
    NSString *startime =  [NSDate cepinYMDFromString:_certificate.Date];
    NSString *endTime = nil;
    if (!endTime || [endTime isEqualToString:@""]) {
        endTime = @"至今";
    }
//    NSString *time = [NSString stringWithFormat:@"%@-%@",startime ,endTime];
    NSString *time = startime;
    [self.timeLabel setText:time];
    [self.positionLabel setText:_certificate.Name];
}
