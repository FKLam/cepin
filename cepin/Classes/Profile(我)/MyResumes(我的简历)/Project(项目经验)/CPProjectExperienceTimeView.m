...
#import "CPCommon.h"
@interface CPProjectExperienceTimeView ()
@property (nonatomic, assign) NSUInteger minYear;
@end
@implementation CPProjectExperienceTimeView
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.maxYear = strYear.intValue;
        self.minYear = self.maxYear - 50;
        for (NSUInteger i = self.minYear; i <= self.maxYear; i++)
        {
