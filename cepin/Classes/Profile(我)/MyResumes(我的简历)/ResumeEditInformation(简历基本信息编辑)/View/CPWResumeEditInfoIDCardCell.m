...
#import "CPCommon.h"
@interface CPWResumeEditInfoIDCardCell ()
@property (nonatomic, strong) UILabel *leftTitleLabel;
@property (nonatomic, strong) UIView *separatorLine;
@end
@implementation CPWResumeEditInfoIDCardCell
...
//            make.width.equalTo( @( self.leftTitleLabel.font.pointSize * 6 ) );
        }];
...
{
    static NSString *reuseIdentifier = @"CPWResumeEditInfoIDCardCell";
    CPWResumeEditInfoIDCardCell *cell = [tableView dequeueReusableCellWithIdentifier:reuseIdentifier];
    if ( !cell )
    {
        cell = [[CPWResumeEditInfoIDCardCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier];
    }
    return cell;
}
