...
#import "CPCommon.h"
@implementation CPWResumeEditExpectWorkLabel
/**
 *  绘制个性化的文字
 *
 */
- (void)drawTextInRect:(CGRect)rect
{
    ...
    // 设置文本行间距
    CGFloat lineSpace = 9.0 / CP_GLOBALSCALE;
    ...
    CGPathAddRect(leftColumnPath, NULL, CGRectMake(0, 0, kScreenWidth - 40 / CP_GLOBALSCALE * 4.0, self.bounds.size.height));
