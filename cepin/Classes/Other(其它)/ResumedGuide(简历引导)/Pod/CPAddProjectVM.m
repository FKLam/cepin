...
- (BOOL)request
{
    ...
    //    {
    //        [OMGToast showWithText:@"请选择公司性质" bottomOffset:ShowTextBottomOffsetY duration:ShowTextTimeout];
    //        return NO;
    //    }
    ...
    //    if ([self.workData.IsAbroad isEqualToString:@"1"]) {
    //        self.workData.IsAbroad = @"true";
    //    }else
    //    {
    //        self.workData.IsAbroad = @"false";
    //    }
    ...
    if ( self.resumeType.integerValue == 1 )
    {
